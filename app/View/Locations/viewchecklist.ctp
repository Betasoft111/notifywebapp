...
<div class="mid-management-cont">
  <div class="wrapper">
      <h2>Update the details for the checklist</h2>
      ...
      <div class="options-cont">
          ...
          <a href="<?php echo HTTP_ROOT; ?>locations/checklistupdate/<?php echo $locid; ?>/<?php echo $id; ?>">
            <div class="options-cont1">
                <span>
                	<div class="edit-loc-cont"></div>
                </span>
                <h3>Edit Details</h3>
                <p>Update the details about the checklist</p>
            </div>
          </a>

          <a href="javascript:void(0)" onclick="deleteChk('<?php echo $id; ?>', '<?php echo $locid; ?>')">
            <div class="options-cont1">
                <span>
                	<div class="delete-cont"></div>
                </span>
                <h3>Delete</h3>
...
<script>
function deleteChk(id, locid) {
	swal({   
		title: 'Are you sure?',
		text: 'You want to remove the checklist!',   
		type: 'warning',   
		...
		function() {
			...
			$.ajax({
				url: '<?php echo HTTP_ROOT; ?>locations/delete_checklist/' + id,
				type: 'get',
				dataType: 'json',
				success: function (response) {
					if(response.success) {
						swal({   
							...
							function() {
							 window.location.href='<?php echo HTTP_ROOT; ?>locations/checklists/' + locid;
						});
					}
				},error: function(err) {
