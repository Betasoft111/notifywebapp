...
<div class="bread-crumb">
    <ul>
        ...
        <li><img src="<?php echo HTTP_ROOT;?>images/arrow.png" alt=""></li>
        <li><a href="<?php echo HTTP_ROOT;?>locations/viewchecklist/<?php echo $locid; ?>/<?php echo $id; ?>" class="active">Details</a></li>
        <li><img src="<?php echo HTTP_ROOT;?>images/arrow.png" alt=""></li>
        <li><a href="javascript:void(0)" class="active">Update</a></li>
    </ul>
</div>  
<div class="main_wrapper">
      ...
      <!--end of header-->
        ...
        <div class="table">
          ...
          <?php echo $this->Form->create('LocationChecklist'); ?>
           ...
           <div class="form">
            ...
            <?php
            echo $this->Form->input('first_name', array('class' => 'clickable', 'value'=>@$checklistData['first_name'], 'label' => false)); ?>
            </div>
            </div>
        ...
        <div class="form">
            ...
            <?php
            echo $this->Form->input('last_name', array('class' => 'clickable' ,'value'=>@$checklistData['last_name'], 'label' => false)); ?>
            </div>
</div>  
            <div class="input text">
           <div class="form">
            ...
            <?php
            echo $this->Form->input('prefered_name', array('class' => 'clickable' ,'value'=>@$checklistData['prefered_name'], 'label' => false)); ?>
            </div>
</div>  
            <div class="input text">
           <div class="form">
            ...
            <?php
            echo $this->Form->input('address', array('class' => 'clickable' ,'value'=>@$checklistData['address'], 'label' => false)); ?>
            </div>
</div>  
            <div class="input text">
         <!--  <div class="form">
            ...
            <?php
            echo $this->Form->input('dob', array('class' => 'clickable', 'value'=>@$checklistData['dob'] )); ?>
            </div>
<!-- </div>   -->
          ...
          <div class="form">
            ...
            <?php
            echo $this->Form->input('cognitive_loss', array('class' => 'clickable', 'value'=>@$checklistData['cognitive_loss'],'label' => false )); ?>
            </div>
</div>  
            <div class="input text">
            <div class="form">
            ...
            <?php
            echo $this->Form->input('hearing_loss', array('class' => 'clickable','value'=>@$checklistData['hearing_loss'], 'label' => false )); ?>
            </div>
</div>  
            <div class="input text">
         <div class="form">
            ...
            <?php
            echo $this->Form->input('visual_impairment', array('class' => 'clickable','value'=>@$checklistData['visual_impairment'], 'label' => false)); ?>
            </div>  
</div>  
            <div class="input text">
          <div class="form">
            ...
            <?php
            echo $this->Form->input('ambulation', array('class' => 'clickable','value'=>@$checklistData['ambulation'], 'label' => false )); ?>
            </div>  
</div>  
            <div class="input text">
            <div class="form">
            ...
            <?php
            echo $this->Form->input('assistive_devices', array('class' => 'clickable','value'=>@$checklistData['assistive_devices'], 'label' => false )); ?>
            </div>        
</div>  
            <div class="input text">
           <div class="form">
            ...
            <?php
            echo $this->Form->input('toileting', array('class' => 'clickable','value'=>@$checklistData['toileting'], 'label' => false )); ?>
            </div>    
</div>  
            <div class="input text">
            <div class="form">
            ...
            <?php
            echo $this->Form->input('bathing', array('class' => 'clickable','value'=>@$checklistData['bathing'], 'label' => false)); ?>
            </div>    
</div>  
            <div class="input text">
            <div class="form">
            ...
            <?php
            echo $this->Form->input('dressing', array('class' => 'clickable' ,'value'=>@$checklistData['dressing'], 'label' => false)); ?>
            </div>    
</div>  
            <div class="input text">
           <div class="form">
            ...
            <?php
            echo $this->Form->input('eating', array('class' => 'clickable' ,'value'=>@$checklistData['eating'], 'label' => false)); ?>
            </div>  
</div>  
            <div class="input text">
            <div class="form">
            ...
            <?php
            echo $this->Form->input('housekeeping', array('class' => 'clickable' ,'value'=>@$checklistData['housekeeping'], 'label' => false)); ?>
            </div>  
</div>  
            <div class="input text">
            <div class="form">
            ...
            <?php
            echo $this->Form->input('shopping', array('class' => 'clickable','value'=>@$checklistData['shopping'], 'label' => false)); ?>
            </div>  
</div>  
            <div class="input text">
           <div class="form">
            ...
            <?php
            echo $this->Form->input('laundry', array('class' => 'clickable' ,'value'=>@$checklistData['laundry'], 'label' => false)); ?>
            </div>         
</div>  
            <div class="input text">
          <div class="form">
            ...
            <?php
            echo $this->Form->input('interests', array('class' => 'clickable' ,'value'=>@$checklistData['interests'], 'label' => false)); ?>
            </div>         
</div>  
