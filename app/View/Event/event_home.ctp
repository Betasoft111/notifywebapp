...
<div class="row">
  <div class="large-4 columns">
      <div class="school_image img"><img src="<?php echo HTTP_ROOT; ?>img/images/Event-image.jpg"></div>
      <br/>
      <br/>
      <address>
      <h1>Location</h1>
...
<div id="videoModal" class="reveal-modal large" data-reveal aria-labelledby="videoModalTitle" aria-hidden="true" role="dialog">
  ...
  <div class="flex-video widescreen vimeo">
    <iframe width="800" height="600" src="https://www.youtube.com/watch?v=LKqllf30mMY" frameborder="0" allowfullscreen></iframe>
  </div>
