...
<div id="page-header-wrapper">
  <div id="top">
    ...
    <div class="welcome">
      ...
      <?php $id = $this->Session->read('Admin.id');
         
      ?>

      <a class="btn ui-state-default ui-corner-all" href="<?php echo HTTP_ROOT.'admin/backends/change_password/'.$id?>">
  ...
  <ul id="navigation" class="sf-js-enabled">
    ...
    <li>
      <a href="javascript:void(0);" class="sf-with-ul"><?php echo('Cms'); ?></a>
      <ul>
        <li>
