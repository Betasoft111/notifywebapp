<div class="attendees index">
	...
	<tr>
		...
		<td><?php echo h($attendee['Attendee']['userid']); ?>&nbsp;</td>
		<td><?php echo h($attendee['Attendee']['eventname']); ?>&nbsp;</td>
		<td><?php echo h($attendee['Attendee']['status']); ?>&nbsp;</td>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $attendee['Attendee']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $attendee['Attendee']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
