...
<div class="beacons_content">
  <div class="large-8 medium-8 small-12 columns">
    ...
    <ul class="beacons_user_services">
    <h2>Beacons</h2>
      <li>What are they</li>
      <li>Scenarios</li>
      <li>tracking Communications channels</li>
      <li>How to use one today in google</li>
      <li>Classic Async</li>
      <li>Universal Analytics Challenges</li>
      <li>Challenges</li>
    </ul>

  </div>
  <div class="large-4 medium-4 small-12 columns"><img src="<?php echo HTTP_ROOT; ?>img/images/Beacons-user-page-image.jpg"></div>
</div>
